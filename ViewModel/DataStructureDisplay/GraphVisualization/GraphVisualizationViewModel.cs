...
namespace Tools.ViewModel.DataStructureDisplay.GraphVisualization;
...
public partial class GraphVisualizationViewModel : ObservableObject {
    ...
    private async Task RandomGenerate() {
        GraphData.Clear();
        await GraphData.RandomGenerate(RandomGenerateType);
        StatusMessage = $"已随机生成{RandomGenerateType}类型的图";
    }
